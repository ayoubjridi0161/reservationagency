...
export default function HotelContainer() {
    function RenderImages(images){
        ...
        return(
            ...
            <div  className='w-1/2 p-4 gap-4  items-center justify-center grid grid-cols-3 grid-rows-5 border-b border-x-zinc-700 '>
    ...
    
    {
        ...
        return (
            <p>{description} <button className='font-bold underline'>see more</button></p>
        )
    }
  ...
  return (
    ...
    <section className='mx-auto my-10  p-5 flex flex-col  w-4/5 min-h-2/3 shadow-md shadow-slate-400 border rounded-lg' >
