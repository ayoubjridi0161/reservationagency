...
/*const hotels = [
  ...
  return (
    <Link to={`/hotels/${id}`} className='w-[30%] h-80 border border-[#919191] rounded-3xl shadow-lg '>
      <img src={image} alt="hotel"   className='drop-shadow-lg  w-full h-2/3 border rounded-t-3xl'/>
